...
const settingsItems = [
  ...
  {
    to: '/app/settings/training-types',
    label: 'Training Types',
    description: 'Configure the types of staff training available for your organisation.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description: 'Choose which features and modules are visible to your team.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    to: '/app/settings/data-protection',
    label: 'Data Protection',
    description: "Review and accept your organisation's legal agreements (DPA, privacy, terms).",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    to: '/app/settings/sub-processors',
    label: 'Sub-processors',
    description: 'Third parties that process data on our behalf, and upcoming changes.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    to: '/app/settings/processing-summary',
    label: 'Processing Activities',
    description: 'Lawful bases and consents in use across your organisation (Art. 30).',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    to: '/app/settings/dpo-contact',
    label: 'Data Protection Contact',
    description: 'How to exercise your rights or raise a data-protection query.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    to: '/app/settings/tenant-purge',
    label: 'Tenant Data Purge',
    description: 'Permanently delete data for terminated tenants past the grace window.',
    superAdminOnly: true,
    icon: (
      <svg
        className="w-6 h-6"
...
export function SettingsPage(): React.ReactElement {
  ...
  const items = settingsItems.filter((i) => !i.superAdminOnly || isSuperAdmin);
  return (
    <div>
      <div className="mb-6">
